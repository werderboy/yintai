//微信二维码
	/*$(".wlog-wechat").hover(function (){
		$(this).children(".erweima").slideDown();
		$(this).children(".blank").show();
		$(this).addClass("hdhover");
	},function(){
		$(this).children(".weixintu,.blank").hide();
		$(this).removeClass();
	})*/
	$(".log-wechat").mouseover(function(){
		$(".erweima",".log-wechat").show();
		$(".blank",".log-wechat").show();
	}).mouseout(function(){
		$(".blank",".log-wechat").hide();
		$(".erweima",".log-wechat").hide();
	})
//手机
	$(".log-phone").mouseover(function(){
		$(".blank",".log-phone").show();
		$(".erweima",".log-phone").show();
	}).mouseout(function(){
		$(".blank",".log-phone").hide();
		$(".erweima",".log-phone").hide();
	})
//我的银泰
...
//购物袋
	$(".gouwudaibox").mouseover(function(){
		$(".gwd-box",".gouwudaibox").show();
	}).mouseout(function(){
		$(".gwd-box",".gouwudaibox").hide();
	})
